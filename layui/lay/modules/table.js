    ...
    M.prototype.config = {
        ...
        if (a.startTime = (new Date).getTime(), n.url) {
            ...
            n.contentType && 0 == n.contentType.indexOf("application/json") && (s = JSON.stringify(s)), t.ajax({
                ...
                headers: n.headers || {},
                success: function (t) {
                    t[r.statusName] != r.statusCode ? (a.renderForm(), a.layMain.html('<div class="' + f + '">' + (t[r.msgName] || "返回的数据状态异常") + "</div>")) : (a.renderData(t, e, eval('t.'+r.countName)), d(), n.time = (new Date).getTime() - a.startTime + " ms"), i && l.close(i), "function" == typeof n.done && n.done(t, e, eval('t.'+r.countName))
                },//t[r.countName]
                error: function (e, t) {
        ...
        n()
        //e[s.response.dataName]
    }, M.prototype.renderData = function (e, n, o, r) {
        var c = this, s = c.config, u = eval('e.'+s.response.dataName) || [], y = [], p = [], m = [], v = function () {
        ...
        if(h.response.dataName.indexOf('.')>-1){
            var keys=h.response.dataName.split('.');
        ...
        c.sortKey = {
            field: n,//u[h.response.dataName]
            sort: i
        }, "asc" === i ? r = layui.sort(y, n) : "desc" === i ? r = layui.sort(y, n, !0) : (r = layui.sort(y, d.config.indexName), delete c.sortKey)
            ,eval('u.'+h.response.dataName+'=r'), c.renderData(u, c.page, c.count, !0), l && layui.event.call(e, s, "sort(" + f + ")", {
            field: n,
            type: i
        })
